    ...
    ** VARIABLES **
    ...
    def create_MassBalances(self):
        ...
        def MassBalance_1_rule(self, u, i):
            return self.FLOW_IN[u, i] == self.FLOW_ADD_TOT[u, i] + sum(
                self.flh[uu] / self.flh[u] * self.FLOW[uu, u, i] for uu in self.UU
            )
        ...
        def MassBalance_9_rule(self, u, i):
            return self.FLOW_WASTE[u, i] == self.FLOW_OUT[u, i] - sum(
                self.FLOW[u, uu, i] for uu in self.UU
            )
        ...
        self.MassBalance_6 = Constraint(
            self.U, self.UU, self.I, rule=MassBalance_6_rule
        )
        self.MassBalance_7 = Constraint(
            self.U, self.UU, self.I, rule=MassBalance_7_rule
        )
        self.MassBalance_8 = Constraint(
            self.U, self.UU, self.I, rule=MassBalance_8_rule
        )
    ...
    def create_DecisionMaking(self):
        ...
        def Test_con(self):
            return self.Y[32000] + self.Y[31000] == 0
